...
{
    public class PlayScreenViewOld : BaseView
    {
        ...
        public Text Title;
        public ColoredButton BackToMenu;

        public List<Color> TextColors;
        public List<SlotWidget> Slots;

        public SubmitButton CreatePlayButton;
        ...
        public Text InputWindowTitle;
        public Text SubmitText;
        public Text CancelText;
        public Button SubmitInputName;
        public Button CancelInputName;

        [Header("Deletion Window")]
        [Space(20)]
        public GameObject DeletionWindow;
        public Text DeletionWindowTitle;
        public Text SubmitDeletionText;
        public Text CancelDeletionText;
        public Button SubmitDeletion;
        public Button CancelDeletion;
        ...
        private void Start()
        {
            if (Storage.IsExists(0))
            {
                PlayerStates[0] = Storage.Load(0);
            }

            if (Storage.IsExists(1))
            {
                PlayerStates[1] = Storage.Load(1);
            }

            if (Storage.IsExists(2))
            {
                PlayerStates[2] = Storage.Load(2);
            }
