...
{
    public class WaterBlueFront : MonoBehaviour
    {
        ...
        private void LoadSprites()
        {
            ...
            ScriptedAnimation asset = resourceManager.CreatePrefab<ScriptedAnimation, EGFXAnimations>(EGFXAnimations.WaterBlueFront);
