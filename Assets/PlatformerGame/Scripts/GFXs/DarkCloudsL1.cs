...
{
    public class DarkCloudsL1 : MonoBehaviour
    {
        ...
        private void LoadSprites()
        {
            ...
            ScriptedAnimation asset = resourceManager.CreatePrefab<ScriptedAnimation, EGFXAnimations>(EGFXAnimations.DarkCloudsL1);
