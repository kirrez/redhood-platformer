...
{
    public class DarkCloudsL2 : MonoBehaviour
    {
        ...
        private void LoadSprites()
        {
            ...
            ScriptedAnimation asset = resourceManager.CreatePrefab<ScriptedAnimation, EGFXAnimations>(EGFXAnimations.DarkCloudsL2);
