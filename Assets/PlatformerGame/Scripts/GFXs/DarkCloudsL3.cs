...
{
    public class DarkCloudsL3 : MonoBehaviour
    {
        ...
        private void LoadSprites()
        {
            ...
            ScriptedAnimation asset = resourceManager.CreatePrefab<ScriptedAnimation, EGFXAnimations>(EGFXAnimations.DarkCloudsL3);
